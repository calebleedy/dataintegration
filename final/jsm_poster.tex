...
\title{\hspace{32cm}Debiased Calibration for Generalized Two-Phase Sampling}
...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
        \node [anchor=north west, inner sep=3cm] at ([xshift=0.0cm,yshift=1.0cm]current page.north west){\includegraphics[height=2.0cm]{logos/watermark.png}}; % Iowa State University watermark
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Introduction}
    ...
    %\sout{This is an important practical problem \cite{yang2020statistical}, 
    %\cite{dagdoug2023model}.} 
