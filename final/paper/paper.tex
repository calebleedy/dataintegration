...
%   \begin{align*}
%   \hat Y_{\ell}(\bm \lambda^*, \bm \phi^*) 
%   &= \hat{Y}_{\rm DCE} + \left(\sum_{i \in A_1} d_{1i} \bf x_i  -
%     \sum_{i \in A_2} d_{1i} \pi_{2i \mid 1}^{-1} \bf x_i  \right)^\top \bm \phi_1^* \\
%   &\quad+ \left(\sum_{i \in A_1} d_{1i} g_i  -
%  \sum_{i \in A_2} d_{1i} \pi_{2i \mid 1}^{-1}g_i  \right)^\top \phi_2^*  
%  \end{align*} 
...
%      \sum\limits_{i \in A_2} \frac{d_{1i}^2}{N^2} 
...
%      \sum\limits_{i \in A_2} \frac{d_{1i}}{N^2} 
