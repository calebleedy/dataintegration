...
%\textcolor{red}{I am not sure about the variance estimation formula in Table 1. They are different from what we discussed before. I wonder whether you can make the sampling rate $n/N$ negligible so that the second term becomes insignificant. How about making $N=50,000$, $n_1=500$, and $n_2=200$?}
