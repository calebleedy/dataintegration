...
\begin{itemize}
  ...
  \item \textbf{Simulation 1 with Monotone MAR}:
   ...
   the oracle estimates of the probabilites. This yields the
   following results:
  ...
  \item \textbf{Simulation 4 with Nonmonotone MAR}:
    ...
    This is clear evidence that the proposed method is doubly robust.

\end{itemize}

\newpage

\section*{Full Nonmonotone Estimator}
