...
\begin{itemize}
  ...
  \item \textbf{Simulation 1 with Monotone MAR}:
   ...
   following results:
    ...
    \input{Tables/nonmonocmar_t-5cy1y20.tex}
    \input{Tables/nonmonocmar_t0cy1y20.tex}
    \input{Tables/nonmonocmar_t5cy1y20.tex}
    ...
    \input{Tables/nonmonocmar_t0cy1y20.1.tex}
    \input{Tables/nonmonocmar_t0cy1y20.5.tex}
    \input{Tables/nonmonocmar_t0cy1y20.9.tex}
  ...
  \item \textbf{Simulation 3 with Nonmonotone MAR}:
    ...
    \input{Tables/nmonocmar_t0cy1y20.tex}
    \input{Tables/nmonocmar_t0cy1y20.1.tex}
    \input{Tables/nmonocmar_t0cy1y20.5.tex}
